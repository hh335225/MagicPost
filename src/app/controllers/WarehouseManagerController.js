...
const warehouse_manager_header = true;
...
class WarehouseManagerController {
    ...
    showList(req, res, next) {
        ...
        var list = ["warehouse_staff", "warehouse_manager"];
        // let post_name = "Ahihi";
        Postal_office.find({ _id: post_code })
            ...
            .then((result) => {
                Users.find({ role: { $in: list }, postal_office_code: post_code }).then(data => {
                    ...
                    data.sort((a, b) => {
                        if (a.role == "warehouse_manager") {
                            return -1;
                        }
                        if (b.role == "warehouse_manager") {
                            return 1;
                        }
                        return 0;
                    })
...
export default new WarehouseManagerController;
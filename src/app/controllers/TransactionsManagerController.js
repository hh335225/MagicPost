...
class TransactionManagerController {
        ...
        Postal_office.findById(new ObjectId(postal_office_code))
            .then(data => {
                if (data) {
                    console.log(data)
                    data = data.toObject();
                    res.render('./transaction_manager_view/transaction_manager', { data, transaction_manager_header })
                } else {
                    res.render('./transaction_manager_view/transaction_manager', { transaction_manager_header })
                }
            })
            .catch(err => {
    ...
    show_hoa_don(req, res, next) {
                ...
                if (parcel) {
                    ...
                    Promise.all(promiseList)
                        .then(tmp => {
                            ...
                            res.render('./transaction_manager_view/hoadon', { parcel, none_header: true })
                        })
        ...
        // res.render('./transaction_manager_view/hoadon',{none_header: true })
    }
    ...
    tra_cuu_don(req, res, next) {
        ...
        Parcels.findOne({ _id: tracking_code })
            .then(data => {
                if (data) {
                    ...
                    Promise.all(promiseList)
                        .then(tmp => {
                            res.render('./transaction_manager_view/tra_cuu_don', { found_parcel, tracking_code, noi_gui, noi_nhan, trang_thai, list_trang_thai, data, transaction_manager_header })
                        })

                } else {
                    res.render('./transaction_manager_view/tra_cuu_don', { found_parcel, tracking_code, transaction_manager_header })
                }
            })
            .catch(err => {
        ...
        // res.render('./transaction_manager_view/tra_cuu_don', {transaction_manager_header})
    }

    danh_sach_don(req, res, next) {
        ...
        findProductList()
            .then(data => {
                ...
                if (data.length != 0) {
                    ...
                    res.render('./transaction_manager_view/danh_sach_don', { checkProduct, data, transaction_manager_header })
                } else {
                    res.render('./transaction_manager_view/danh_sach_don', { checkProduct, transaction_manager_header })
                }
            })
            .catch(err => {
                console.log(err)
                    ...
                    Postal_office.findById(new ObjectId(postal_office_code))
                        .then(data2 => {
                            if (data2) {
                                ...
                                res.render('./transaction_manager_view/tao_tui_hang', { data2, data, transaction_manager_header })
                            }
                        })
                        .catch(err => {
                            res.status(500).send("Loi SV");
    ...
    danh_sach_tui_di(req, res, next) {
        res.render('./transaction_manager_view/danh_sach_tui_di', { transaction_manager_header })
    }
        ...
        findBagList()
            .then(data => {
                ...
                if (data.length != 0) {
                    ...
                    // res.render('./transaction_manager_view/danh_sach_don', {checkBag, data, transaction_manager_header})
                } else {
                    res.json({
                        checkBag: checkBag
                    })
    ...
    danh_sach_tui_nhan(req, res, next) {
        res.render('./transaction_manager_view/danh_sach_tui_nhan', { transaction_manager_header })
    }
            ...
            .then(data_ => {
                ...
                Parcels.find({ _id: { $in: product_id_list } })
                    .then(product_list => {
                        ...
                        res.render('./transaction_manager_view/xac_nhan_chi_tiet_tui', { data1, product_list, none_header: true })
                    })
            }).catch(err => {
                res.status(500).send("loi SV")
            })
                ...
                if (data) {
                    ...
                    Promise.all(promises)
                        .then(data_ => {
                            ...
                            res.render('./transaction_manager_view/thong_tin_tui_hang', { data1, data_, transaction_manager_header })
                        })
                } else {
                    res.status(500).send("loi SV");
                }
    ...
    show_giao_thanh_cong(req, res, next) {
        res.render('./transaction_manager_view/danh_sach_giao_thanh_cong', { transaction_manager_header })
    }

    show_giao_that_bai(req, res, next) {
        res.render('./transaction_manager_view/danh_sach_giao_that_bai', { transaction_manager_header })
    }
